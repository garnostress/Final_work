# Generated by Django 4.1.5 on 2023-12-06 16:46
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            managers=[("objects", backendAPI.models.UserManager()),],
        ),
        migrations.CreateModel(
            name="Category",
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "product_name",
                    models.CharField(max_length=80, verbose_name="Название товара"),
                ),
                ("external_id", models.PositiveIntegerField(verbose_name="Внешний ИД")),
                (
                    "quantity",
        ...
        migrations.AddConstraint(
            model_name="product",
            constraint=models.UniqueConstraint(
                fields=("shop", "category", "external_id"), name="unique_product_info"
            ),
        ),
        migrations.AddConstraint(
            model_name="orderitem",
            constraint=models.UniqueConstraint(
                fields=("order_id", "product_name"), name="unique_order_item"
            ),
        ),
    ]
